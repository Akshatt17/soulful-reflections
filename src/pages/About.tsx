...
const About = () => {
  return <PageLayout>
      {/* Hero Section */}
      <section>
        <div className="container-custom px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
      ...
      <section className="section-padding">
        <div className="container-custom px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="radial-tint text-center mb-14 py-4">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            {/* Left - Text Content */}
            <div className="glass-panel p-8 space-y-6 text-lg text-foreground/85 leading-relaxed">
            ...
            <div className="glass-panel p-8 lg:p-10">
              ...
              <ul className="space-y-5">
                <li className="flex items-start gap-4">
                  ...
                  <span className="text-lg text-foreground/85 pt-1.5">Insight brings empowerment</span>
                </li>
                <li className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center">
                    <Heart className="w-5 h-5 text-primary" />
                  </div>
                  <span className="text-lg text-foreground/85 pt-1.5">Compassion creates change</span>
                </li>
                <li className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center">
                    <Eye className="w-5 h-5 text-primary" />
                  </div>
                  <span className="text-lg text-foreground/85 pt-1.5">Awareness makes recovery possible</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="section-padding">
        <div className="container-custom px-4 sm:px-6 lg:px-8">
          ...
          }].map((item, index) => <div key={item.title} className="glass-panel glass-panel-hover p-8" style={{
            animationDelay: `${index * 0.1}s`
          }}>
                <div className="w-12 h-12 bg-sage/25 rounded-xl flex items-center justify-center mb-5">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative animate-scale-in">
              <div className="glass-panel overflow-hidden p-2">
                <img src={drNiharika} alt="Dr. Niharika Bhaskar" className="w-full h-auto object-cover aspect-[4/5] rounded-xl" />
              </div>
            </div>

            {/* Right - Credentials */}
            <div className="space-y-6">
              <div className="radial-tint py-3">
              ...
              <div className="space-y-4">
                <div className="glass-panel flex items-start gap-4 p-4">
                  <div className="flex-shrink-0 w-10 h-10 bg-primary/10 rounded-xl flex items-center justify-center">
                    <GraduationCap className="w-5 h-5 text-primary" />
                  </div>
                  <div>
                    <h4 className="font-semibold text-foreground">Education</h4>
                    <p className="text-foreground/75 text-sm">MBBS, MD Psychiatry</p>
                  </div>
                </div>
                ...
                <div className="glass-panel flex items-start gap-4 p-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/75 text-sm">Anxiety, Depression, Stress Management & Emotional Well-being</p>
                  </div>
                </div>
                ...
                <div className="glass-panel flex items-start gap-4 p-4">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/75 text-sm">Compassionate, evidence-based care with focus on holistic mental wellness</p>
                  </div>
                </div>
              </div>
      ...
      <section className="section-padding">
        <div className="container-custom px-4 sm:px-6 lg:px-8">
          <div className="radial-tint max-w-3xl mx-auto text-center py-8">
            <h2 className="font-serif text-3xl sm:text-4xl font-bold text-primary mb-4">
              Begin Your Journey
            </h2>
            <p className="text-lg text-foreground/80 mb-10 max-w-xl mx-auto leading-relaxed">
