...
const ToolAssessment = () => {
  ...
  const isStandardAssessment = isPHQ9 || isGAD7;

  const questionCount = isPHQ9 ? 9 : isGAD7 ? 7 : tool.questions.length;
  ...
  const showCrisisResources = useMemo(() => {
    ...
    return false;
  }, [question9Flagged, totalScore, isPHQ9, isGAD7]);
