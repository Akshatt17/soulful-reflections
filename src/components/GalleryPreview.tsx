...
// The three newest videos, linked to their detail pages.
const videos = mediaData.video.slice(0, 3).map((v) => ({
  slug: v.slug,
  title: v.title,
  youtubeId: v.youtubeId,
}));

/** One compact right-aligned media pane; the full gallery lives at /gallery. */
